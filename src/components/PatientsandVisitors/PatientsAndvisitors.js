    ...
    return (
        <div className="container-fluid">
            <Row className="p-3 mb-4">
                <h1 className="fw-bold">Bill Payment</h1>
                <Col lg={6} md={6} sm={12}>
                    <p>You may pay an existing bill online, through your MyChart account or Guest Pay, or by phone using a debit or credit card by calling 617.414.5155.
                    ...
                    <p>Four full-service ATMs are located throughout the hospital for your convenience.
                                ...
                                (on the first floor near the Albany Street Emergency Department entrance)</p>
                </Col>
                <Col lg={6} md={6} sm={12}>
                    <img className="w-75" src={bill} alt="" />
                </Col>
            </Row>
            <Row className="p-3 mt-4 mb-4">
                <Col lg={7} md={6} sm={12}>
...
For providers: more details are available in policy 3.00.300 on the intranet.</p>
                 ...
                 <Col lg={5} md={6} sm={12}>
                     <img className="w-100" src={accessible} alt="" />
                </Col>
            </Row>
            <Row className="p-3 mt-4 mb-4">
                <Col lg={4} md={6} sm={12}>
