...
const Getcareform = () => {
    ...
    <Form.Floating  className="mb-3 fw-bold text-primary">
        ...
        />
        <label htmlFor="floatingPasswordCustom">Doctor Name</label>
    </Form.Floating>
    ...
    <button type="submit" className="btn btn-info fw-bold rounded my-3 w-50" >Send</button>
        </form>
    );
};

export default Getcareform;