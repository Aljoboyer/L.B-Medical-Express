...
const Innovating = () => {
    return (
        <div className="container-fluid invt-contain">
            ...
            <Row  className=" mt-4 mb-4 p-3">
                <Col     data-aos-duration="500"
    data-aos-easing="ease-in-out"
    data-aos-once="false" data-aos="flip-left"  className="colam" lg={6} md={6} sm={12}>
                    <img  className="w-75" src={imgone} alt="" />
                ...
                <img  className="w-75" src={imgtwo} alt="" />
                ...
                <Col  className="colam" lg={6} md={6} sm={12}>
                <img  className="w-75" src={imgthree} alt="" />
    ...
    data-aos-easing="ease-in-out"
    data-aos-once="false" data-aos="flip-left"  className="colam" lg={6} md={6} sm={12}>
                <img  className="w-75" src={imgfour} alt="" />
