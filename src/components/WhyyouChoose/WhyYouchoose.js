...
const WhyYouchoose = () => {
    return (
        <div className="container-fluid" >
            ...
            <Row className="mt-4 p-3 text-center">
                <Col data-aos-offset="200"
    data-aos-delay="50" data-aos-duration="1000"
    data-aos-easing="ease-in-out"
    data-aos-once="false" data-aos="fade-right"   className="mt-4 p-2 " lg={3} md={6} sm={12}>
    ...
    data-aos-delay="50" data-aos-duration="1000"
    data-aos-easing="ease-in-out"
    data-aos-once="false" data-aos="fade-up" className="mt-4 p-2" lg={3} md={6} sm={12}>
    ...
    data-aos-delay="50" data-aos-duration="1000"
    data-aos-easing="ease-in-out"
    data-aos-once="false" data-aos="fade-down" className="mt-4 p-2" lg={3} md={6} sm={12}>
    ...
    data-aos-delay="50" data-aos-duration="1000"
    data-aos-easing="ease-in-out"
    data-aos-once="false" data-aos="fade-left" className="mt-4 p-2" lg={3} md={6} sm={12}>
